...
![Application Server](images/application-server.jpg)
...
Let’s serve what you built for [AirBnB clone v3](https://intranet.alxswe.com/projects/301) - RESTful API on web-01.
